  ...
  return (
    <div className="min-h-screen" style={{ fontFamily: "var(--font-rubik), Rubik, sans-serif", background: "#f1f5f9" }} dir="rtl">
      <div className="px-8 py-5 flex items-center justify-between" style={{ background: "#0F2645", borderBottom: "1px solid rgba(14,165,233,0.1)" }}>
        <div>
          <h1 className="text-white font-black text-xl" style={{ letterSpacing: "-0.02em" }}>לוח המשרות</h1>
          <p className="text-slate-400 text-sm mt-0.5">{jobs.length} משרות פעילות</p>
        </div>
